...
In this analysis, all WGS samples (both India and China) were included.
...
Running fastStructure was quite a journey. With this dataset (all sites included), we needed to use catalpa and at least 225 GB of RAM. It took both the k1 and k2 population sizes about 16 hours to complete.  It took other datasets (because of the high number of iterations) over 30 hours to complete.
...
#### k2 with "known" geographic origin

![k2-go](../data/fastStructure/go2.png)

#### k3 with "known" geographic origin

![k3-go](../data/fastStructure/go3.png)

#### k2 by primate research center

![k2-pmc](../data/fastStructure/pmc2.png)

#### k3 by primate research center

![k3-pmc](../data/fastStructure/pmc3.png)

Additional figures are located on the MCSR in `/ddn/home3/vallender/projects/NPRC_Pedigree_Project/results/fast_structure/all_auto_wgs_all_biallelic_maf05/pophelper_analysis`.
